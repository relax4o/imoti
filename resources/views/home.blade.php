    ...
    <div class="tab-pane active" id="tab">
            ...
            <div class="boxes">
                <div class="boxes_img ImageWrapper">
                    <a href="single-property.html">
                        <img class="img-responsive" src="{{ asset('/assets/home/demos/01_home.jpg') }}" alt="">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
            <div class="boxes">
                <div class="boxes_img ImageWrapper">
                    <a href="single-property.html">
                        <img class="img-responsive" src="{{ asset('/assets/home/demos/02_home.jpg') }}" alt="">
                        <div class="PStyleNe"></div>
                    </a>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 last">
            <div class="boxes">
                <div class="boxes_img ImageWrapper">
                    <a href="single-property.html">
                        <img class="img-responsive" src="{{ asset('/assets/home/demos/03_home.jpg') }}" alt="">
                        <div class="PStyleNe"></div>
                    </a>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 first">
            <div class="boxes">
                <div class="boxes_img ImageWrapper">
                    <a href="single-property.html">
                        <img class="img-responsive" src="{{ asset('/assets/home/demos/04_home.jpg') }}" alt="">
                        <div class="PStyleNe"></div>
                    </a>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
            <div class="boxes">
                <div class="boxes_img ImageWrapper">
                    <a href="single-property.html">
                        <img class="img-responsive" src="{{ asset('/assets/home/demos/05_home.png') }}" alt="">
                        <div class="PStyleNe"></div>
                    </a>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 last">
            <div class="boxes">
                <div class="boxes_img ImageWrapper">
                    <a href="single-property.html">
                        <img class="img-responsive" src="{{ asset('/assets/home/demos/06_home.png') }}" alt="">
                        <div class="PStyleNe"></div>
                    </a>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 first">
            <div class="boxes">
                <div class="boxes_img ImageWrapper">
                    <a href="single-property.html">
                        <img class="img-responsive" src="{{ asset('/assets/home/demos/07_home.png') }}" alt="">
                        <div class="PStyleNe"></div>
                    </a>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
            <div class="boxes">
                <div class="boxes_img ImageWrapper">
                    <a href="single-property.html">
                        <img class="img-responsive" src="{{ asset('/assets/home/demos/08_home.png') }}" alt="">
                        <div class="PStyleNe"></div>
                    </a>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 last">
            <div class="boxes">
                <div class="boxes_img ImageWrapper">
                    <a href="single-property.html">
                        <img class="img-responsive" src="{{ asset('/assets/home/demos/09_home.png') }}" alt="">
                        <div class="PStyleNe"></div>
                    </a>
