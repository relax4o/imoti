		...
		<div class="col-sm-3">
			<div class="panel panel-profile">
			  <div class="panel-body">
			    <img src="{{ $data->avatar or asset('images/no_avatar.png') }}" class="img-circle">
			    <div class="name">{{ ( auth()->user()->IsAgency() ) ? $data->agency_name : $data->complete_name }}</div>
			    <div class="info">Graphic Designer</div>
			    <ul class="list-inline text-center">
			    	@if ( isset($data->facebook) )
			    		<li><a href="{{ url($data->facebook) }}" class="profile-facebook-icon" target="_blank"><i class="ti ti-facebook"></i></a></li>
			    	@endif

			    	@if ( isset($data->twitter) )
			    		<li><a href="{{ url($data->twitter) }}" class="profile-twitter-icon" target="_blank"><i class="ti ti-twitter"></i></a></li>
			    	@endif

			    	@if ( isset($data->google) )
			    		<li><a href="#" class="profile-google-icon"><i class="ti ti-google"></i></a></li>
			    	@endif
			    </ul>
			  </div>
			</div><!-- panel -->
			<div class="list-group list-group-alternate mb-n nav nav-tabs">
				<a href="#tab-about" 	role="tab" data-toggle="tab" class="list-group-item active"><i class="ti ti-user"></i> About <span class="badge badge-primary">80%</span></a>
								    ...
								    <div class="table-responsive">
								      <table class="table">
								        <tbody>
								          <tr>
								            <th>Web</th>
								            <td><a href="#" contenteditable="true">www.johndoe.com</a></td>
								          </tr>
								          <tr>
								            <th>Email</th>
											...
											<div class="timeline-body">
												...
												<div class="timeline-content">
													...
													<ul class="list-inline">
														<li><img src="assets/demo/stockphoto/blog_06.jpg" alt="" class="pull-left img-thumbnail img-responsive clearfix" width="200"></li>
														<li><img src="assets/demo/stockphoto/blog_05.jpg" alt="" class="pull-left img-thumbnail img-responsive clearfix" width="200"></li>
													</ul>
												</div>
											</div>
										</li>
								...
								<div class="col-md-12">
									<form class="form-horizontal tabular-form">
										...
										<div class="form-group">
											...
											<div class="col-sm-8 tabular-border">
												<div class="radio block icheck"><label><input type="radio" name="gender"> Male</label></div>
												<div class="radio block icheck"><label><input type="radio" name="gender"> Female</label></div>
											</div>
										</div>
										<div class="form-group">
...
@section('scripts')
<script type="text/javascript" src="{{ asset('/assets/profile/demo/demo-profile.js') }}"></script>
@stop