<div class="sidebar">
	<div class="widget">
        <div class="widget-body">
            <div class="userinfo">
                <div class="avatar">
                    <img src="{{ asset('/assets/profile/demo/avatar/avatar_15.png') }}" class="img-responsive img-circle"> 
                </div>
                <div class="info">
	...
	<div class="widget stay-on-collapse" id="widget-sidebar">
        <nav role="navigation" class="widget-body">
			<ul class="acc-menu">
				...
				<li><a href="{{ url('/profile/dashboard') }}"><i class="ti ti-home"></i><span>Dashboard</span><span class="badge badge-teal">2</span></a></li>
