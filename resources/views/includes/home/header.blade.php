               ...
               <div class="logo-wrapper clearfix">
					<div class="logo">
						<a href="{{ url('/') }}" title="Home">
							<img src="{{ asset('/assets/home/images/logo.png') }}" alt="Estate">
						</a>
					</div><!-- /.site-name -->
				</div><!-- /.logo-wrapper -->
            </div>         
            ...
            <div class="menudrop container">
                ...
                <div id="defaultmenu" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <!-- Mega Menu -->
                        <li class="dropdown fhmm-fw active"><a href="{{ url('/') }}"><i class="fa fa-home"></i> {{ trans('common.home') }}</a></li><!-- mega menu -->
                        <!-- list elements -->
                        <li class="dropdown fhmm-fw"><a href="#AdvSearchModal" data-toggle="modal">{{ trans('common.adv_search') }}</b></a></li><!-- end list elements -->
                        <!-- list elements -->
                        <li class="dropdown fhmm-fw"><a href="#">{{ trans('common.last_estates') }}</b></a></li><!-- end list elements -->
